...
namespace EMC
{
    ...
    {
        private PowerPmacManager _powerPmacManager;

        [ObservableProperty] public ObservableCollection<PowerPmacMotion> powerPmacMotionList;

        [ObservableProperty] private PowerPmacMotion selectedMotion;
        [ObservableProperty] private DMotionPosition selectedPosition;

        public USub06ViewModel(PowerPmacManager powerPmacManager)
        {
            this._powerPmacManager = powerPmacManager;
            PowerPmacDevice device = _powerPmacManager.FindDevice();
            if (device != null)
            {
                PowerPmacMotionList = device.MotionList;
            }
